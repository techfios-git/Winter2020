package Techfios.com.addcategory;
...
public class addlevi1 {
	...
	public static void main(String[] args) throws Exception {
						...
						//driver.findElement(By.name("allbox")); WebElement ToggleAll =
						  driver.findElement(By.name("categorydata")).sendKeys("Levi's Data");
						  Thread.sleep(9000);
						  //driver.findElement(By.name("submit")).click();
						  //driver.findElement(By.xpath([@id="extra"]/input[2]).click();
						  driver.findElement(By.xpath(("//input[@value='Add category']"))).click();
						  //driver.findElement(By.name("allbox")); Boolean checkToggleAll =
						  //ToggleAll.isSelected();
						  
						  //if (checkToggleAll == false) {
						  //System.out.println(" Toggle All is not checked!"); } else {
